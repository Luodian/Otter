...
class SEEDBenchDataset(BaseEvalDataset):
    def __init__(self, data_path: str = "Otter-AI/SEEDBench", split="test", cache_dir=None, default_output_path: str = "./logs/SEEDBench"):
    ...
    def evaluate(self, model):
        ...
        output_file_name = os.path.join(self.default_output_path, "results.json")
