...
import generate.search as search
from torch import Tensor
from generate.ngram_repeat_block import NGramRepeatBlock
...
class SequenceGenerator(nn.Module):
    def __init__(
        ...
        self.search = (
            search.BeamSearch(self.tokenizer) if search_strategy is None else search_strategy
        )
