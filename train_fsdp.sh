...
accelerate launch --config_file=/mnt/petrelfs/zhangyuanhan/Otter/accelerate_configs/accelerate_config_fsdp.yaml \
...
--run_name=multi_instruct_chunyuan-core_lr1e-5_6epochs_fsdp_accelerator_fp16_gas2 \
