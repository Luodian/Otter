...
accelerate launch --config_file=/mnt/petrelfs/zhangyuanhan/Otter/accelerate_configs/accelerate_config_zero2.yaml \
pipeline/train/instruction_following_ds.py \
