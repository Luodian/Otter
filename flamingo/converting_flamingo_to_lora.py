...
lang_decoder_short_name = MODEL_CLASSES[model.config.text_config.architectures[0]]
...
model.lang_decoder = get_peft_model(model.lang_decoder, lora_config)
model.lang_decoder.print_trainable_parameters()
