...
2. 🏎️ [Run Otter Locally](./pipeline/demo). You can run our model locally with at least 16G GPU mem for tasks like image/video tagging and captioning and identifying harmful content. For details, please refer to the [code](./pipeline/demo). We fix a bug at inference video (mistakenly unsqueeze frame tensors to input `vision_x`), you could try it again!
